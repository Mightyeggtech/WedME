    ...
    return (
            ...
            <div className="wrap">
                <section className="container-fluid" > 
                    <Row className="vbs-heroimg" id="privacySection"> 
                            ...
                            <Row>
                                ...
                                <Col lg={12} xl={8}> 
                                    <div className="custom-items-align">
                                        <h1 className="home-title font-montserrat font-uppercase">Privacy</h1>
                                    </div>
                                </Col>
                                <Col xl={2}></Col>
                            </Row>
...
However, in the unlikely event of anyone having any objection to content put up on our site, they are free to contact us immediately and we ll be happy to consider their request and take necessary action</p>
                                <li>Updates on Privacy Policy</li>
                                <p>We reserve the right to revise these Privacy Policies of Wedmegood.com from time to time by updating this posting. Such revised policies will take effect as of the date of posting</p>
                                <li>Contact Us</li>
